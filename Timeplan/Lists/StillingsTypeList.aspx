<%@ Page Title="Stillingstyper" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StillingsTypeList.aspx.cs" Inherits="Timeplan.Lists.StillingsTypeList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button CssClass="btn btn-lg btn-default btn-float-right" runat="server" Text="Opprett ny stillingstype" OnClick="CreateNewButton_Click" ID="CreateNewButtonTop" />
    ...
    <section>
        <div>
            ...
            <asp:ListView
                ID="StillingsTypeListView"
                runat="server"
                ItemPlaceholderID="StillingsTypeItem"
                    ...
                    <table style="width: 100%;">
                        <tbody>
                            <tr class="listview-heading">
                                ...
                                <th>
                                    <asp:LinkButton CommandName="Sort" CommandArgument="TimerElevarbeid" ID="TimerElevarbeidLinkButton" runat="server">Timer elevarbeid</asp:LinkButton>
                                    <div class="show-hide">
                                        <asp:LinkButton runat="server" OnClick="HideShowLinkButton_OnClick" Text="V/S" ID="HideShowTimerElevarbeidLinkButton"></asp:LinkButton>
                                    </div>
                                </th>
                                <th>
                                    <asp:LinkButton CommandName="Sort" CommandArgument="TimerSamarbeid" ID="TimerSamarbeidLinkButton" runat="server">Timer samarbeid</asp:LinkButton>
                                    <div class="show-hide">
                                        <asp:LinkButton runat="server" OnClick="HideShowLinkButton_OnClick" Text="V/S" ID="HideShowTimerSamarbeidLinkButton"></asp:LinkButton>
                                    </div>
                                </th>
                                <th>
                            ...
                            <tr id="StillingsTypeItem" runat="server"></tr>
                        </tbody>
                    </table>
                </LayoutTemplate>
                ...
                <ItemTemplate>
                    <tr class="row-standard">
                        ...
                        <td>
                            <div class="form-group">
                                <asp:TextBox CssClass="form-control" runat="server" ID="TimerElevarbeidTextBox" MaxLength="5" Text='<%# Eval("TimerElevarbeid") %>'></asp:TextBox>
                                <div class="error-message">
                                    <asp:RangeValidator runat="server" ID="TimerElevarbeidRangeValidator" ControlToValidate="TimerElevarbeidTextBox" Type="Double" MinimumValue="0" MaximumValue="100" Display="Dynamic" ErrorMessage="Ugyldig antall" />
                                    <asp:RequiredFieldValidator runat="server" ID="TimerElevarbeidRequiredFieldValidator" ControlToValidate="TimerElevarbeidTextBox" Display="Dynamic" ErrorMessage="Påkrevd" />
                                </div>
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <asp:TextBox CssClass="form-control" runat="server" ID="TimerSamarbeidTextBox" MaxLength="5" Text='<%# Eval("TimerSamarbeid") %>'></asp:TextBox>
                                <div class="error-message">
                                    <asp:RangeValidator runat="server" ID="TimerSamarbeidRangeValidator" ControlToValidate="TimerSamarbeidTextBox" Type="Double" MinimumValue="0" MaximumValue="100" Display="Dynamic" ErrorMessage="Ugyldig antall" />
                                    <asp:RequiredFieldValidator runat="server" ID="TimerSamarbeidRequiredFieldValidator" ControlToValidate="TimerSamarbeidTextBox" Display="Dynamic" ErrorMessage="Påkrevd" />
                                </div>
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="form-group btn-delete">
                                <asp:LinkButton CssClass="form-control btn btn-sm btn-default" runat="server" 
                                    ...
                                    CommandArgument='<%# Eval("Id") %>' OnClick="DeleteButton_Click" ID="DeleteLinkButton" ToolTip="Slett stillingstype">
    ...
    <asp:Button CssClass="btn btn-lg btn-default" runat="server" Text="Opprett ny stillingstype" OnClick="CreateNewButton_Click" ID="CreateNewButtonBottom" />
    ...
    <script type="text/javascript">
        ...
        function ConfirmDelete(name) {
            if (confirm("Er du sikker på at du vil slette stillingstype '" + name + "'?")) {
                return true;
            }
            return false;
        }
